...
* Lab exercises
As usual, code files and automated tests have been provided. For this lab, there is only one tester, but several independent programs, each containing a task to implement.
